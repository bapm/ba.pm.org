...
dbus-pidgin.pl - Enable a Pidgin account through D-Bus.
...
dbus-pidgin.pl ACCOUNT PROTOCOL

Where I<ACCOUNT> is the name of a Pidgin account and I<PROTOCOL> the protcol
used by the account.
